...
reposync -n --repoid=docker-ce-stable --repoid=docker-ce-edge -p /data/repo/CentOS/docker/x86_64/
echo 数据同步结束
...
createrepo --update /data/repo/CentOS/x86_64/docker-ce-stable/
createrepo --update /data/repo/CentOS/x86_64/docker-ce-edge/